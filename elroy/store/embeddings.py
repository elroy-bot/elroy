...
get_most_relevant_entity = partial(get_closest_vector_match, table=MemoryEntity)
...
get_relevant_entities = partial(get_vector_matches_over_threshold, table=MemoryEntity)
