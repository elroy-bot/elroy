...
class ElroyApp(App):
    ...
    def _render_existing_context_messages(self, context_messages: list) -> None:
        ...
        from ..repository.context_messages.validations import is_synthetic_conversation_start_message
        ...
        for message in context_messages:
            ...
            if not message.content:
                continue
            if is_synthetic_conversation_start_message(message):
                continue
