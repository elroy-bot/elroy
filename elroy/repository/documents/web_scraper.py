# Largely adapted from https://github.com/Aider-AI/aider/blob/main/aider/scrape.pyA
...
from ...cli.updater import run_install

aider_user_agent = f"Elroy/{__version__} elroy.bot"
...
def install_playwright(io):
    ...
    pip_cmd = get_pip_install(["aider-chat[playwright]"])
    ...
    success, output = run_install(chromium_cmd)
    if not success:
        io.tool_error(output)
        return
...
class Scraper:
    ...
    def scrape(self, url) -> Optional[str]:
        """
