...
class WaitlistSignup(SQLModel, table=True):
    ...
    use_case: str | None = Field(default=None, description="Use case provided by the user")
    platform: str | None = Field(default=None, description="Platform preference (iOS/Android)")
