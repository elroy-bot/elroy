...
My experience building with LLM's started with watching in amazement as two [Autogen](https://github.com/microsoft/autogen) made small talk with each other on my computer. I quickly realized that making a really cool demo was a lot easier than building a useful application.
