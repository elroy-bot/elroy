    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/elroy-bot/elroy/tree/main/docs/',
        },
        blog: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'PyPI',
              href: 'https://pypi.org/project/elroy/',
            },
          ],
        },
      ],
      copyright: `Copyright © ${new Date().getFullYear()} Elroy Team. Built with Docusaurus.`,
    },
    prism: {
