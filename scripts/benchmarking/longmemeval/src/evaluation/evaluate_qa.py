...
if __name__ == "__main__":
    ...
    with open(result_file, "w") as out_f:
        ...
        for entry in tqdm(hypotheses):
            ...
            kwargs = {"model": metric_model, "messages": [{"role": "user", "content": prompt}], "n": 1, "temperature": 0, "max_tokens": 10}
            ...
            logs.append(entry)
            if verbose:
                print(json.dumps({"question": q, "answer": ans, "hypothesis": hyp, "autoeval_label": label}, indent=4), flush=True)
